...
class Anuncios extends Model
{
    public function getTotalAnuncios($filtros)
    {
        ...
        $sql = $this->conn->prepare("SELECT COUNT(*) as c FROM anuncios WHERE ". implode(' AND ', $filtrosstring));
    ...
    {
        $sql = $this->conn->prepare("INSERT INTO anuncios(id_usuario, id_categoria, titulo, descricao, valor, estado)
    ...
    {
        $sql = $this->conn->prepare("UPDATE anuncios SET id_usuario = :id_usuario,
        ...
        if(count($fotos) > 0){
            for ($q = 0; $q < count($fotos['tmp_name']); $q++){
                ...
                if(in_array($tipo, array('image/jpeg','image/png'))){
                    ...
                    $sql = $this->conn->prepare("INSERT INTO anuncios_imagens (id_anuncio, url)
